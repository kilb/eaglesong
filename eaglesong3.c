...
void EaglesongPermutation( uint32_t * state ) {
    ...
    for( i = 0 ; i < ROUND ; ++i ) {
        p0=state[0];p1=state[1];p2=state[2];p3=state[3];
        p4=state[4];p5=state[5];p6=state[6];p7=state[7];
        p8=state[8];p9=state[9];p10=state[10];p11=state[11];
        p12=state[12];p13=state[13];p14=state[14];p15=state[15];
