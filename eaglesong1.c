...
void EaglesongPermutation( uint32_t * state ) {
    ...
    for( i = 0 ; i < ROUND ; ++i ) {
        ...
        tmp0 = pre[0]^pre[4]^pre[12]^pre[15];

        tmp1 = tmp0^pre[1]^pre[8]^pre[13];
        tmp0 ^= pre[5]^pre[6]^pre[7];
        ...
        tmp0 = pre[0]^pre[1]^pre[2]^pre[4]^pre[6]^pre[12]^pre[13]^pre[14];
        tmp1 = tmp0^pre[3]^pre[8]^pre[10];
        tmp0 ^= pre[7]^pre[9]^pre[15];
        ...
        tmp0 = pre[2]^pre[3]^pre[7]^pre[14];
        tmp1 = tmp0^pre[0]^pre[8]^pre[10];
        tmp0 ^= pre[1]^pre[4]^pre[5]^pre[9]^pre[11]^pre[13]^pre[15];
        ...
        tmp0 = pre[9]^pre[15];
        tmp1 = tmp0^pre[0]^pre[2]^pre[6]^pre[7]^pre[10];
        tmp0 ^= pre[1]^pre[3]^pre[4]^pre[8]^pre[11];
        ...
        tmp0 = pre[0]^pre[1]^pre[11]^pre[15];
        tmp1 = tmp0^pre[2]^pre[9]^pre[13];
        tmp0 ^= pre[3]^pre[4]^pre[5]^pre[6]^pre[8]^pre[10]^pre[12];
...
int main() {
    ...
    uint8_t output[40];
    uint8_t input[32];
    uint64_t nonce = 9471987766257875727;
    scanf("%lu", &nonce);
    for(int i=0; i<32; ++i) {
        input[i+8] = i + 75;
    }
    
    ((uint64_t*)input)[0] = htole64(nonce);
	...
	t1 = clock();
	for (int i = 0; i < sum; ++i)EaglesongHash(output, input, 40);
	t2 = clock();
