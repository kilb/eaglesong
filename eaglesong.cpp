...
char input1[10000] = "11111111111111111111111111111111112";
char input2[10000] = "11111111111111111111111111111111113";
unsigned char output[32];
int main() 
{
	int c,i,j,sum = 1000000,temp0;
	clock_t t1, t2;

	t1 = clock();
	for (i = 0; i < sum; ++i)EaglesongHash(output, input, 60);
	t2 = clock();
